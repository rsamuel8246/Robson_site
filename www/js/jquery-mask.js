	...
	var y = function(a, h, g) {
		...
		var d = {
			...
			getMasked : function(a) {
				var b = [], f = d.val(), e = 0, p = h.length, l = 0, s = f.length, m = 1, t = "push", q = -1, n, u;
				...
				for (; u(); ) {
					var v = h.charAt(e), w = f.charAt(l), r = k.translation[v];
					if (r)
			...
			callbacks : function(c) {
				var b = d.val(), f = d.val() !== x;
				if (!0 === f && "function" === typeof g.onChange)
					g.onChange(b, c, a, g);
				if (!0 === f && "function" === typeof g.onKeyPress)
					g.onKeyPress(b, c, a, g);
				if ("function" === typeof g.onComplete && b.length === h.length)
					g.onComplete(b, c, a, g)
			}
		};
		k.remove = function() {
			d.destroyEvents();
